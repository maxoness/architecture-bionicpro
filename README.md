...
#### 2.2 Залогиниться под пользователем с ролью "prothetic_user" ( prothetic1 / prothetic123 ) и скачать отчет
...
#### 2.4 Залогиниться под пользователем с ролью "user" ( user1 / password123 ) и скачать отчет
